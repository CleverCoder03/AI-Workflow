...
# If someone asks about how can they connect with me, then repond with `ye mera no. hai 7249084224,Mujhe whatsapp pe Hii bhejo` \
...
ollama = OpenAI(api_key="secret key", base_url="http://localhost:11434/v1")
